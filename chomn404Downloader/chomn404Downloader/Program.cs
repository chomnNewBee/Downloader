...
class Program
{
    ...
    public static void Main(string[] args)
    {
        ...
        else
        {
            ...
            Console.WriteLine("请输入远程资源服务器域名：");
...
// 拦截请求响应
        FiddlerApplication.BeforeResponse  += session =>
        {
            ...
            {
                if (session.responseCode == 404)
                {
                    OnHttp404(session.fullUrl);
    ...
    private static void OnHttp404(string url)
    {
